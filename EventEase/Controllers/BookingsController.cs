...
namespace EventEase.Controllers
{
    public class BookingsController : Controller
    {
        ...
        {
            ViewData["EventModelId"] = new SelectList(_context.Events, "EventModelId", "EventModelId");
        ...
        public async Task<IActionResult> Create([Bind("BookingId,EventModelId,VenueId,BookingDate")] Booking booking)
        {
            ...
            ViewData["EventModelId"] = new SelectList(
                _context.Events,
                "EventModelId",
                "EventModelId",
                booking.EventModelId
            );
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["EventModelId"] = new SelectList(_context.Events, "EventModelId", "EventModelId", booking.EventModelId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookingId,EventModelId,VenueId,BookingDate")] Booking booking)
        {
